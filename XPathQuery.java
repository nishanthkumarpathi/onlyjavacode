...
public class XPathQuery extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Example XPath Query: "/users/user[username='anderson' and password='java']/name"
			// XPath Injection: "/users/user[username='' or '1'='1' and password='' or '1'='1']/name"
